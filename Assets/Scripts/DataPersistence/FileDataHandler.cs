...
public class FileDataHandler
{
    ...
    {
        this.dataDirPath = Path.Combine(dataDirPath,"Saves");
    ...
    public GameData Load(string profileId, bool allowRestoreFromBackup = true) 
    {
        ...
        if (File.Exists(fullPath)) 
        {
            ...
            catch (Exception e) 
            {
                ...
                {
                    Debug.Log("Error occured when trying to load file at path: " 
    ...
    public void Save(GameData data, string profileId) 
    {
        ...
        if (profileId == null) 
        {
            Debug.Log("Save failed: profileId is null.");
            return;
        }
    ...
    public void Delete(string profileId) 
    {
        ...
        {
            Debug.Log("Failed to delete profile data for profileId: " 
    ...
    private bool AttemptRollback(string fullPath) 
    {
        ...
        {
            Debug.Log("Error occured when trying to roll back to backup file at: " 
                + backupFilePath + "\n" + e);
        }
